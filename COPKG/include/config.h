...
#define BITSIZEOF_SIZE_T BITSIZEOF_PTRDIFF_T
...
#define INSTALLPREFIX INSTALLPREFIX_SHOULD_NOT_BE_USED
...
/* Define to l, ll, u, ul, ull, etc., as suitable for constants of type
   'wchar_t'. */
#define WCHAR_T_SUFFIX hu

/* Define to l, ll, u, ul, ull, etc., as suitable for constants of type
   'wint_t'. */
#define WINT_T_SUFFIX hu
